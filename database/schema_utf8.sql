...
-- Users table (for Authentication - Admin and Customers)
CREATE TABLE Users (
...
CREATE TABLE Bookings (
    ...
    booking_reference_id VARCHAR(20) UNIQUE NOT NULL,
    ...
    cancellation_policy_id UUID REFERENCES CancellationPolicies(policy_id),
...
CREATE TABLE Services (
    ...
    pricing_unit VARCHAR(50) DEFAULT 'Per Person',
