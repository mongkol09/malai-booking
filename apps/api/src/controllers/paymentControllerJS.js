// ============================================
// PAYMENT CONTROLLER - WORKING VERSION
// ============================================
// Uses JavaScript require to bypass TypeScript cache issues
...
const createCharge = async (req, res) => {
  try {
    ...
    // Mock omiseService for testing
    const omiseService = {
      formatAmount: (amount) => amount * 100,
      createCharge: async (chargeRequest) => ({
...
const handleOmiseWebhook = async (req, res) => {
  try {
    ...
    // Store webhook event for audit (using webhookEvent model)
    ...
    // Find payment by Omise charge ID (using omiseChargeId field)
