                    ...
                    <div className="card-body">
                        <ul className="nav nav-tabs px-0" role="tablist">
                            <li className="nav-item dropdown">
                                <Link className="nav-link gray-6 active dropdown-toggle" data-bs-toggle="dropdown" to="/" role="button">Month</Link>
                                <ul className="dropdown-menu border-0 shadow py-3 px-2" data-popper-placement="top-start" style={{position: "absolute", "inset": "auto auto 0px 0px", margin: "0px", transform: "translate(0px, -44px)"}}>
                                    <li><Link className="dropdown-item py-1 rounded active" to="/">Jan 2023</Link></li>
                                    <li><Link className="dropdown-item py-1 rounded" to="/">Feb 2023</Link></li>
                                    <li><Link className="dropdown-item py-1 rounded" to="/">March 2023</Link></li>
                                    <li><Link className="dropdown-item py-1 rounded" to="/">Apr 2023</Link></li>
                                    <li><Link className="dropdown-item py-1 rounded" to="/">May 2023</Link></li>
                                </ul>
                            </li>
                            <li className="nav-item" role="presentation">
                                <Link className="nav-link gray-6" data-bs-toggle="tab" to="#nav-week1" role="tab" aria-selected="true">
                                    <i className="bi bi-check2 text-success me-1"></i>
                                    <span>Full Day Present</span>
                                </Link>
                            </li>
                            <li className="nav-item" role="presentation">
                                <Link className="nav-link gray-6" data-bs-toggle="tab" to="#nav-week1" role="tab" aria-selected="false" tabIndex="-1">
