export const tuningData = [
    ...
    {
        icon: 
        <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="mb-3"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0"></path><path d="M21 21l-6 -6"></path></svg>,
        title:'Search',
        text:'Description text here...',
        path:'search',
        theme_color:'var(--theme-color1)'
    },
    {
        ...
        text:'จัดการราคาพิเศษสำหรับวันหยุดและเทศกาล',
