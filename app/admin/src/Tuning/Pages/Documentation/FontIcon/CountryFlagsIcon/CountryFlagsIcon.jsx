...
<span className="flag-icon flag-icon-gr flag-icon-squared"></span> `;
  ...
  return (
    	<div className="content px-xl-5 px-lg-4 px-3 py-3 page-body bg-card">
			...
			<p className="lead">A collection of all country flags in SVG — plus the CSS for easier integration. See the <Link to="https://flagicons.lipis.dev/" rel="nofollow"  target="_blank">demo</Link></p>
			...
			<div className="card-body p-0">
				<div className="row g-xl-5 g-4">
					<div className="col-12">
						...
						<div role="alert" className="alert alert-info">Check out a <Link target="_blank" to="https://github.com/lipis/flag-icon-css">https://github.com/lipis/flag-icon-css</Link> of the Flag Icon.</div>
					</div>
				</div>
