				...
				<div className="row g-4">
					<div className="col-12">							
						<ul>
							...
							<li>Once again, due to <code>position: fixed</code>, there are some caveats with using modals on mobile devices. <Link to="https://getbootstrap.com/docs/5.1/getting-started/browsers-devices/#modals-and-dropdowns-on-mobile">See our browser support docs</Link> for details.</li>
