			...
			<div className="card-body p-0">
				...
				<div className="row g-4">
					...
					<div className="col-12">
						...
						<Link className="me-1 btn btn-primary" to="/" role="button">Link</Link>
					...
					<div className="col-12">
						...
						<Link className="btn btn-primary btn-lg disabled me-1" role="button" aria-disabled="true">Primary link</Link>
						<Link className="btn btn-secondary btn-lg disabled me-1" role="button" aria-disabled="true">Link</Link>
					</div>
					<div className="col-12">
						<h5>Block buttons</h5>
					...
					<div className="col-12">
						...
						<div className="card">
							...
							<div className="card-body">
								...
								<p>Combine button-like checkbox and radio <Link to="/docs/5.1/forms/checks-radios/">toggle buttons</Link> into a seamless looking button group.</p>
